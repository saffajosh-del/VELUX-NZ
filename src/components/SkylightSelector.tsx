            ...
            {(customerId !== 'velux') ? (
                <div className="mb-12 flex justify-center items-center w-full">
                    ...
                    <div className="flex-1 flex justify-start pl-4">
                        <img src={`/${customerId}-logo.png`} alt={partnerName} className={`object-contain origin-left ${customerId === 'itm' ? 'h-16 scale-[1.6] ml-2' : 'h-16'}`} onError={(e) => { e.currentTarget.style.display = 'none'; }} />
                    </div>
                </div>
            ) : (
